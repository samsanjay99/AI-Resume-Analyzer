                        ...
                        try:
                            ...
                            if _deploy_result.get("success"):
                                ...
                                try:
                                    ...
                                    UserDataManager.save_deployment(
                                        user_id=user_id,
                                    ...
                                    print(f"Warning: Could not save deployment to database: {db_err}")
                            else:
                            ...
                            with st.spinner("🧠 AI is analyzing your resume..."):
                                ...
                                if analysis_result and "error" not in analysis_result:
                                    ...
                                    try:
                                        ...
                                        if resume_id:
                                            # Now save AI analysis with proper resume_id and user_id
                                            ...
                                            # Also save basic analysis data with user_id
                                            analysis_data = {
                                                'resume_id': resume_id,
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            if st.session_state.get('is_admin', False):
                ...
                if st.button("Admin Logout", key="logout_button"):
                    try:
